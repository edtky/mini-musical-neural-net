...
def main(filename):
    ...
    filedir = 'txt-files/notewise/custom/'
    ...
    note_stream.write('midi', fp="output-midi-files/notewise/custom/"+filename[:-4]+".mid")
    print("Done! Decoded midi file saved to '/output-midi-files/notewise/custom/'")
